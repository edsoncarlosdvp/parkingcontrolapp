...
public class ParkingSpotController {
	...
	public ResponseEntity<Object> saveParkingSpot(@RequestBody @Valid ParkingSpotDto parkingSpotDto){
		...
		if(parkingSpotService.existsByApartamentAndBlock(parkingSpotDto.getApartament(), parkingSpotDto.getBlock())) {
			return ResponseEntity.status(HttpStatus.CONFLICT).body("Conflict: Parking Spot alredy registred for this apartament/block!");
		}
	...
	public ResponseEntity<Object> updateParkingSpot(@PathVariable(value = "id") UUID id, @RequestBody @Valid ParkingSpotDto parkingSpotDto){
		...
		parkingSpotModel.setBrandCar(parkingSpotDto.getBranCar());
		parkingSpotModel.setColorCar(parkingSpotDto.getBranCar());
		parkingSpotModel.setResponsibleName(parkingSpotDto.getResponsabileName());
		parkingSpotModel.setApartment(parkingSpotDto.getApartament());
